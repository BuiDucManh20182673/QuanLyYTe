...
public class StaffList {
    ...
    public int add(Staff stf){
        ...
        try{
            String sSQL = "insert into clinic.staff(ID, FullName, Birthday, Gender, PhoneNumber, Position, Ca) values(?, ?, ?, ?, ?, ?, ?)";
    ...
    public int updateStaffbyId(Staff stf){
        ...
        PreparedStatement sttm = null;
        try{
            String sSQL = "update clinic.staff set FullName = ?, Birthday = ?,  Gender = ?, PhoneNumber = ?, position = ?, ca = ? where ID = ?";
            conn = DatabaseUtils.getDBConnect();
            sttm = conn.prepareStatement(sSQL);
    ...
    public int delStaffByID(String id){
        ...
        PreparedStatement sttm = null;
        try{
            String sSQL = "delete from clinic.staff where ID = ?";
            conn = DatabaseUtils.getDBConnect();
            sttm = conn.prepareStatement(sSQL);
            sttm.setString(1, id);
    ...
    public List<Staff> getAllStaff(){
        ...
        ResultSet rs = null;
        try{
            String sSQL = "select * from clinic.staff";
            conn = DatabaseUtils.getDBConnect();
    ...
    public Staff getStaffById(String id){
        ...
        Staff stf = new Staff();
        try{
            String sSQL = "select * from clinic.staff where ID = ?";
            conn = DatabaseUtils.getDBConnect();
            sttm = conn.prepareStatement(sSQL);
            sttm.setString(1, id);
