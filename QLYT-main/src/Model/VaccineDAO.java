...
public class VaccineDAO {
    public static List<Vaccine> findAll() {
        ...
        try {
            ...
            //query
            String sql = "select * from clinic.vaccine";
    ...
    public static void insert(Vaccine vac) {
        ...
        try {
            //lay tat ca danh sach sinh vien
            //connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/clinic? zeroDateTimeBehavior = round", "root", "haihai20");
            connection = DatabaseUtils.getDBConnect();
            //query
            String sql = "insert into clinic.vaccine(type, quanlity, lo, date) values(?, ?, ?, ?)";
    ...
    public static void update(Vaccine vac) {
        ...
        try {
            ...
            //query
            String sql = "update clinic.vaccine set type=?,quanlity=?,lo=?,date=? where id = ?";
            statement = connection.prepareCall(sql);
    ...
    public static void delete(String id) {
        ...
        try {
            connection = DatabaseUtils.getDBConnect();
            String sql = "delete from clinic.vaccine where id=?";
            statement = connection.prepareCall(sql);
    ...
    public static List<Vaccine> search(String vaccineLo ) {
        ...
        try {
            ...
            //query
            String sql = "select * from clinic.vaccine where lo like ?";
            statement = connection.prepareCall(sql);
